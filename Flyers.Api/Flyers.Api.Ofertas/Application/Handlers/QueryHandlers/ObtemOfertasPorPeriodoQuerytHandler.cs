...
{
    public class ObtemOfertasPorPeriodoQuerytHandler : IRequestHandler<ObtemOfertasPorPeriodoQuery, List<Oferta>>
    {
        private readonly IOfertaDataService _ofertaDataService;
        private readonly IArquivoDataService _arquivoDataService;
        private readonly IMapper _mapper;

        public ObtemOfertasPorPeriodoQuerytHandler(
        ...
        public async Task<List<Oferta>> Handle(
            ObtemOfertasPorPeriodoQuery request, 
            CancellationToken cancellationToken)
        {
            try
            {
                ...
                var ofertas = await _ofertaDataService
                    .ListaPorDatasAsync(request.Inicio, request.Termino);
                ...
                return _mapper.Map<List<OfertaEntity>, List<Oferta>>(ofertas.ToList());
            }
